...
1. **Start a Kubernetes cluster in your cloud environment**
   ...
   In this example the `v1.kube1.18.15` is the cluster template for the Kubernetes
   ...
   ```console
   $ openstack coe cluster create --cluster-template v1.kube1.18.15 \
                                  --keypair my-key \
                                  my-cluster
   ```
